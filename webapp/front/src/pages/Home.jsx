    ...
    <div className="relative min-h-screen bg-slate-50 text-slate-900 font-['Space_Grotesk'] dark:bg-[#0b0f14] dark:text-[#f5f7fb] transition-colors duration-300">
      ...
      <section className="relative z-[2] mx-auto max-w-[1280px] px-6 pb-[60px] pt-5 md:px-20 md:pb-20 md:pt-6">
        ...
        <section className="mt-[90px] grid scroll-mt-[120px] grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6" id="membres">
          {[
            { title: "Portage du projet", desc: "Maxime Boudier, étudiant CNAM ingénieur BDIA (2e année), pilote le cadrage, la vision produit et l’intégration OSINT.", tasks: ["Note de cadrage et objectifs PoC.", "Coordination des jalons et livrables.", "Validation des hypothèses métier."], cta: "Voir le parcours" },
            { title: "Équipe data & IA", desc: "Modélisation des séries temporelles et mise en évidence de la valeur ajoutée des données externes.", tasks: ["Comparaison modèle classique vs Kairoscope.", "Feature engineering sur les signaux OSINT.", "Évaluation continue de la précision."], cta: "Méthodo data" },
            { title: "Terrain & expérience", desc: "Retours des commerçants pour s’assurer d’une application simple, conviviale et réellement utile.", tasks: ["Interviews et tests d’usage en conditions réelles.", "Amélioration continue du tableau de bord.", "Mesure de l’impact opérationnel."], cta: "Voir l’impact" }
          ].map((card, index) => (
