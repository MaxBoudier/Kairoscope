...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-slate-900 font-['Space_Grotesk'] dark:bg-[#0b0f14] dark:text-[#f5f7fb] transition-colors duration-300">
      ...
      {/* Banner Image */}
      <div className="hidden md:block pointer-events-none fixed inset-0 z-0 scale-[1.03] transform bg-[url('/Images/banner.png')] bg-contain bg-[center_top] bg-no-repeat blur-[2px] opacity-90 dark:opacity-60 transition-opacity duration-300"></div>
        ...
        <section className="mt-[90px] grid scroll-mt-[120px] grid-cols-1 md:grid-cols-2 gap-6" id="membres">
          {[
            ...
            <article key={index} className="flex flex-col rounded-[20px] border border-slate-200 bg-white/80 p-[26px] shadow-lg backdrop-blur-[12px] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl dark:border-white/12 dark:bg-[rgba(16,20,28,0.75)] dark:shadow-[0_20px_50px_rgba(3,5,8,0.4)] dark:hover:border-[#e8ff6a]/35 dark:hover:shadow-[0_28px_70px_rgba(3,5,8,0.55)]">
              ...
              <div className="mt-auto pt-4 border-t border-slate-100 dark:border-white/5 flex flex-col items-start gap-2">
                {member.name.includes("Arthur Cielsar") && (
                ...
                <a
                  ...
                  className={`inline-flex items-center gap-2 transition-colors ${member.name.includes("Arthur")
                    ? "text-[#0077b5] scale-125 origin-left font-bold"
                    : "text-slate-400 hover:text-[#0077b5] dark:text-slate-500 dark:hover:text-[#0a66c2]"
                    }`}
                ...
                >
                  ...
                  {member.name.includes("Arthur") && "Mon LinkedIn"}
                </a>
              </div>
